...
- **Context-Sensitive Help**: `{FeatureName}-csh.md` — field- and surface-mapped short help for UI anchors; also the in-app / task-oriented help surface for this feature (do not create a separate Online Help file). Use the global skill `write-doc`
